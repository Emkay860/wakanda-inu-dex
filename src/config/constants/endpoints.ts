...
export const INFO_CLIENT = 'https://api.thegraph.com/subgraphs/name/emkay860/exchange'

// export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks'
export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/emkay860/blocks'
